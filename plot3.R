...
##make the png file and print the line graph based on format criteria defined by the assignment
png(filename = "plot3.png", width = 480, height = 480)
plot(HPCFeb$DateTime, HPCFeb$Sub_metering_1, type = "l", ylim = c(0, max(HPCFeb$Sub_metering_1, HPCFeb$Sub_metering_2, HPCFeb$Sub_metering_3)))
